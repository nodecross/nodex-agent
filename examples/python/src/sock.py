...
path_by_deb = "/home/nodex/.nodex/run/nodex.sock"
target_path = path_by_deb if os.path.exists(path_by_deb) else default_path

# Construct the base URL using the Unix socket path
base = f'http+unix://{urllib.parse.quote(target_path, safe="")}'
